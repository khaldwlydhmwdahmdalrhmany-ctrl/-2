              ...
              <div className="relative w-full max-w-md sm:max-w-lg rounded-3xl overflow-hidden shadow-2xl border-4 border-slate-800 bg-slate-950">
                ...
                <div className="absolute bottom-6 right-6 left-6 text-right">
                  ...
                  <p className="text-[11px] text-slate-100 mt-1.5 leading-relaxed font-bold">
                    نسجل تاريخ بيع وتوصيل فلترك بدقة لنوافيك بمستحقات تبديل الشمعات الثلاث لتظل كفاءتها 100%.
                  </p>
                </div>
              </div>
            </div>
...
// Structs lists
const audienceList = [
  { icon: <Home className="w-6 h-6 text-[#0072ff]" />, title: 'المنازل والفلل السكنية', desc: 'لتأمين كفاي تامة ومستمرة لأسركم من مياه الشرب المتوازنة والآمنة للأشخاص والرضع.' },
  { icon: <Building2 className="w-6 h-6 text-[#0072ff]" />, title: 'الشركات والمكاتب والمطابخ', desc: 'برادات تحلية ذكية مدمجة لحماية الموظفين وصناع القهوة بلا زحمة تجميع قنان المياه.' },
  { icon: <Coffee className="w-6 h-6 text-[#0072ff]" />, title: 'المقاهي والمطاعم المتميزة', desc: 'محطات RO لازالة الترسبات وتحسين جودة استخلاص القهوة والمذاقات الرائعة بالاسبرسو.' },
...
const whyChooseUsList = [
  ...
  },
  {
    ...
    desc: 'نوفر صيانة دورية مجدولة وتذكير مستمر ومراقبة كفاءة وضغط مياهك. نلتزم خطياً بضمانات تصل لغاية 5 سنوات على قطع وفنيات التركيب.'
  },
  {
    icon: <Heart className="w-5 h-5" />,
    title: 'دفع بالتقسيط مع تمارا وتابي',
    desc: 'لا تحمل هم تكلفة الفلتر الفوري! نوفر تقسيط مباشر بدون فوائد لجميع خدماتنا المعتمدة لتبقى بيوتكم واحة فياضة بالصحة والنقاء.'
  }
];
